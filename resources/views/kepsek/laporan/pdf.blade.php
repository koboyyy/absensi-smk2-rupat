...
<head>
    ...
    <style>
        ...
        h3 { margin: 14px 0 6px 0; font-size: 12px; border-left: 3px solid #2563eb; padding-left: 8px; }
        ...
        /* Stats Cards */
        .cards { width: 100%; margin-top: 10px; border: none; }
        .cards td { border: 0; padding: 0; }
        .card { border: 1px solid #e5e7eb; padding: 10px; border-radius: 8px; background: #f9fafb; }
        .card-title { font-size: 10px; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em; }
        ...
        <tr>
            ...
            <td style="width:25%; padding:0 4px;">
                <div class="card">
                    ...
                    <div class="card-value" style="color: #ca8a04;">{{ $summary['S'] }}</div>
                </div>
            </td>
            <td style="width:25%; padding:0 4px;">
                <div class="card">
                    <div class="card-title">Total Izin</div>
                    <div class="card-value" style="color: #2563eb;">{{ $summary['I'] }}</div>
                </div>
            </td>
            <td style="width:25%; padding-left:8px;">
                <div class="card">
                    <div class="card-title">Total Alfa</div>
                    <div class="card-value" style="color: #dc2626;">{{ $summary['A'] }}</div>
                </div>
            </td>
        </tr>
    </table>
