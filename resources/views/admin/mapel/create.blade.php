@extends('layouts.app', ['title' => 'Tambah Mapel'])

@section('content')
    <div class="mb-4 flex items-center justify-between">
        <div class="text-xl font-bold">Tambah Mapel</div>
    ...
    <form method="POST" action="{{ route('admin.mapel.store') }}"
        ...
        <div>
            ...
            <input name="kode_mapel" value="{{ old('kode_mapel') }}"
        ...
        <div>
            ...
            <input name="nama_mapel" value="{{ old('nama_mapel') }}"
                   class="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 focus:border-blue-500 focus:outline-none dark:border-slate-800 dark:bg-slate-950">
