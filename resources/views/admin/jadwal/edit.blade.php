    ...
    <form method="POST" action="{{ route('admin.jadwal.update', $item->jadwal_id) }}"
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div>
                ...
                <input name="hari" value="{{ old('hari', $item->hari) }}"
            ...
            <div>
                ...
                <input type="time" name="jam_mulai" value="{{ old('jam_mulai', $item->jam_mulai) }}"
                       class="w-full rounded-xl border border-slate-200 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
            ...
            <div>
                ...
                <input type="time" name="jam_selesai" value="{{ old('jam_selesai', $item->jam_selesai) }}"
                       class="w-full rounded-xl border border-slate-200 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
