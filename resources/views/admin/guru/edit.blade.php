...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.guru.update', $item->guru_id) }}"
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
                ...
                <input name="username" value="{{ old('username', $item->user?->username) }}" class="w-full rounded-xl border border-slate-200 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
            ...
            <div>
                ...
                <select name="status" class="w-full rounded-xl border border-slate-200 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
                    @foreach(['aktif','nonaktif'] as $s)
                        <option value="{{ $s }}" @selected(old('status', $item->user?->status)===$s)>{{ $s }}</option>
                    @endforeach
                </select>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
                ...
                <input name="nama_guru" value="{{ old('nama_guru', $item->nama_guru) }}" class="w-full rounded-xl border border-slate-200 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
            ...
            <div>
                ...
                <input name="nip" value="{{ old('nip', $item->nip) }}" class="w-full rounded-xl border border-slate-200 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
                ...
                <input name="no_hp" value="{{ old('no_hp', $item->no_hp) }}" class="w-full rounded-xl border border-slate-200 px-4 py-3 dark:border-slate-800 dark:bg-slate-950">
