    ...
    <div class="min-h-full flex flex-col md:flex-row">
        ...
        >
            <div class="flex items-center gap-3 px-6 py-8">
                ...
                <div class="leading-tight">
                    <div
                        class="font-bold text-slate-800 dark:text-white tracking-tight"
                    >
                        SMKN 2 RUPAT
                    </div>
                    <div
                        class="text-[10px] font-medium text-blue-600 dark:text-blue-400 uppercase tracking-widest"
                    >
                        Sistem Absensi
                    </div>
                </div>
            ...
            <nav class="flex-1 overflow-y-auto px-4 space-y-1">
                @auth
                    <div
                        class="mb-2 px-2 text-[10px] font-bold text-slate-400 uppercase tracking-wider dark:text-slate-500"
                    >
                        Menu Navigasi
                    </div>
                    @php
            ...
            <div class="border-t border-slate-100 p-4 dark:border-slate-800">
                @auth
                    ...
                    <div
                        class="flex items-center gap-3 rounded-2xl bg-slate-50 p-3 dark:bg-slate-800/50"
                    >
                        <div
                            class="h-10 w-10 flex-shrink-0 overflow-hidden rounded-xl border border-blue-200 bg-blue-100 flex items-center justify-center dark:border-blue-800 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400"
                        >
        ...
        <div class="flex-1 md:ml-72">
            <main class="px-4 py-8 sm:px-6 lg:px-8">
                @if (session('success'))
                    <div
                        class="mb-6 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800 dark:border-emerald-900/40 dark:bg-emerald-950/40 dark:text-emerald-200 flex items-center gap-2"
                    >
